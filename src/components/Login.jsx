  ...
  return (
    <div>
      ...
      <div className="absolute">
        <img className="w-screen h-screen object-cover" src={BG_IMG} alt="bgImg" />
      </div>

      <form className="absolute bg-[#000000bb] p-12  w-full md:w-3/12 my-36 mx-auto right-0 left-0 text-white rounded-md">
